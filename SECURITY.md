...
**Related:** [docs/architecture/07-security-architecture.md](docs/architecture/07-security-architecture.md) · Setup Topic 07
...
| Supply chain | Trivy CRITICAL gate → cosign Sigstore keyless → digest-only Git references |
| Admission | Kyverno: deny `:latest`, require digests, ECR allowlist |
